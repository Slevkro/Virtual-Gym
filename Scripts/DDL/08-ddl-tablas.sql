...
CREATE TABLE ADMINISTRADOR(
    ...
    USING INDEX (
        CREATE UNIQUE INDEX ADMINISTRADOR_PK_IUK ON ADMINISTRADOR(EMPLEADO_ID)
...
CREATE TABLE SALA(
    ...
    USING INDEX (
        CREATE UNIQUE INDEX SALA_CLAVE_IUK ON SALA(CLAVE)
        TABLESPACE EMP_GIM_IDXS_TS
    )
) TABLESPACE GIMNASIO_TS
;
...
CREATE TABLE STATUS_APARATO(
    ...
    USING INDEX (
        CREATE UNIQUE INDEX STATUS_APARATO_PK_IUK ON STATUS_APARATO(STATUS_ID)
        TABLESPACE EMP_GIM_IDXS_TS
    ),
